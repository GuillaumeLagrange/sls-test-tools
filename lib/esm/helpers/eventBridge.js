...
class EventBridge {
  ...
  async getEvents() {
    ...
    const messageHandlers = (0, _removeUndefinedMessages.removeUndefinedMessages)((_result$Messages = result.Messages) === null || _result$Messages === void 0 ? void 0 : _result$Messages.map(message => ({
